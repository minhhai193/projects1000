		...
		<tbody  class="boxPro">
			...
			foreach($accstaff as $result){
				...
				<tr>
					...
					<td id="xuly"><a href="index.php?act=accstaff_edit&id=<?php echo $result['Id_User_Staff']; ?>" title="S?a"><img src="../images/icon/pencil.png" alt="S?a"></a> <a href="?delid=<?php echo $result['Id_User_Staff'] ?>" title="Xoá"><img src="../images/icon/close.png" alt="Xoá"></a></td>
				</tr>
				<?php 
			}
			?>
